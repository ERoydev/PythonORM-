# Generated by Django 5.0.4 on 2024-08-01 11:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('director', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='director', to='main_app.director')),
                ('starring_actor', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='main_actor', to='main_app.actor')),
            ],
            options={
                'abstract': False,
            },
